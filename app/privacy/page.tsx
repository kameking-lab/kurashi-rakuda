...
export default function PrivacyPage() {
  return (
    <div>
      ...
      <p>
        当サイトは、サイトの改善のためにアクセス解析ツール（Google
        Analytics）を利用することがあります。アクセス解析はトラフィックデータを匿名で収集するもので、個人を特定するものではありません。データの収集を望まない場合は、ブラウザの設定やGoogleが提供するオプトアウト手段で無効にできます。
      </p>
