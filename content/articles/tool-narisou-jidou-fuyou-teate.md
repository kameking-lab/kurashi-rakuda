...
本記事は[児童扶養手当 計算（ひとり親）](/tools/money/jidou-fuyou-teate)に対応しています。子どもの人数、受給者の所得、扶養親族数などを入力し、全部支給・一部支給・支給停止の目安と月額を確認するツールです。制度全体の対象要件は[児童扶養手当の制度解説](/articles/seido-jidou-fuyou-teate)も参照してください。
