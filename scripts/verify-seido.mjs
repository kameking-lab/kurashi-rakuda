...
const ALLOWED_MUNICIPAL_DOMAINS = [
  ...
  'city.ibaraki.osaka.jp', // 茨木市（施行時特例市）の公式サイト（西日本全国展開・2026-07-18）
  'city.kishiwada.osaka.jp', // 岸和田市（施行時特例市）の公式サイト（西日本全国展開・2026-07-18）
  'city.takarazuka.hyogo.jp', // 宝塚市（施行時特例市）の公式サイト（西日本全国展開・2026-07-18）
  'city.tokushima.tokushima.jp', // 徳島市の公式サイト（西日本全国展開・2026-07-18）
];
